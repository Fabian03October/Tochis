            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Editar Configuración: {{ $setting->name }}
                    </h3>
                ...
                <form action="{{ route('admin.mercadopago.update', $setting) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password" 
                                               ...
                                               id="access_token" 
                                               name="access_token" 
                                               value="{{ old('access_token', $setting->access_token ? '••••••••••••••••' : '') }}" 
                                               placeholder="TEST-xxx o APP_USR-xxx">
                                    ...
                                    <small class="form-text text-muted">
                                        Deje en blanco para mantener el token actual
                                    </small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('terminal_type') is-invalid @enderror" 
                                        ...
                                        <option value="point" {{ old('terminal_type', $setting->terminal_type) == 'point' ? 'selected' : '' }}>
                                            MercadoPago Point
                                        </option>
                                        <option value="smart" {{ old('terminal_type', $setting->terminal_type) == 'smart' ? 'selected' : '' }}>
                                            Point Smart
                                        </option>
                                        <option value="mini" {{ old('terminal_type', $setting->terminal_type) == 'mini' ? 'selected' : '' }}>
                                            Point Mini
                                        </option>
                                        <option value="pro" {{ old('terminal_type', $setting->terminal_type) == 'pro' ? 'selected' : '' }}>
                                            Point Pro
                                        </option>
                                    </select>
                                    @error('terminal_type')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" 
                                           ...
                                           id="success_url" 
                                           name="success_url" 
                                           value="{{ old('success_url', $setting->success_url) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" 
                                           ...
                                           id="failure_url" 
                                           name="failure_url" 
                                           value="{{ old('failure_url', $setting->failure_url) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" 
                                           ...
                                           id="pending_url" 
                                           name="pending_url" 
                                           value="{{ old('pending_url', $setting->pending_url) }}" 
                        ...
                        <div class="alert alert-info">
                            <h6><i class="fas fa-info-circle"></i> Información de Estado</h6>
                            <div class="row">
                                <div class="col-md-6">
                                    <strong>Creado:</strong> {{ $setting->created_at->format('d/m/Y H:i:s') }}
                                </div>
                                <div class="col-md-6">
                                    <strong>Última actualización:</strong> {{ $setting->updated_at->format('d/m/Y H:i:s') }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.mercadopago.show', $setting) }}" class="btn btn-info">
...
$(document).ready(function() {
    ...
    const originalToken = '{{ $setting->access_token }}';
    
    // Toggle token visibility
    $('#toggleToken').click(function() {
        const tokenInput = $('#access_token');
        ...
        if (tokenVisible) {
            ...
            tokenInput.val(originalToken);
            icon.removeClass('fa-eye').addClass('fa-eye-slash');
            tokenVisible = true;
        }
    });
    
    // Limpiar campo de token si se está editando
    $('#access_token').focus(function() {
        if ($(this).val() === '••••••••••••••••') {
            $(this).val('');
        }
    });
    ...
    $('form').submit(function(e) {
        ...
        // Solo validar si se está cambiando el token
        ...
        // Si el token no se cambió, removerlo del formulario
        if (accessToken === '••••••••••••••••') {
            $('#access_token').remove();
        }
    });
